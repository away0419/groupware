<template>
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary">결재 대기 목록</h6>
    </div>
    <div class="card-body">
      <div class="table-responsive">
        <table class="table table-bordered table-hover">
          ...
          <tbody>
            <tr v-if="waitReceiveList == ''">
              <td colspan="3" align="center">최근 항목이 없습니다.</td>
            </tr>
            <tr v-else v-for="(item, index) in waitReceiveList" :key="index">
...
export default {
  ...
  created() {
    receiveList(
      ...
      (res) => {
        this.waitReceiveList = res.data.list;
      },
      () => {},
    );
  },
