<template>
  <div id="birthModal" hide-backdrop hide-footer>
    <div class="velas">
      <div class="fuego"></div>
      <div class="fuego"></div>
      <div class="fuego"></div>
  ...
  c-7.606-0.447-6.058-37.895-20.62-23.333c-10.167,10.166-15.972-0.747-25,12C119.547,443.568,121.798,416.515,111.547,415.233z
    ...
    <div class="text" @click="closePopUp">
      <h1 class="t1">happy birthday!</h1>
      <p>빠른 퇴근하세요!</p>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    closePopUp() {
      ...
      getBirthCookie.check = "false";
      this.$cookies.set("IsBirthDay", getBirthCookie);
      window.close();
    },
  },
};
