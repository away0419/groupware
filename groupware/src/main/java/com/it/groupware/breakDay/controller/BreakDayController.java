...
import com.it.groupware.breakTheme.model.BreakThemeDTO;
import com.it.groupware.breakTheme.model.BreakThemeService;
...
public class BreakDayController {
	...
	private final BreakThemeService breakThemeService;
	...
	@ApiOperation(value="휴가 종류 목록")
	public ResponseEntity<Map<String,Object>> selectAll(){
		Map<String,Object> data = new HashMap<>();
		List<BreakThemeDTO> thList = breakThemeService.selectAll();
		if(thList==null)
			throw new CustomException(CustomErrorCode.BREAKTHEME_LIST_NULL, "데이터가 없음");
		data.put("themeList", thList);
